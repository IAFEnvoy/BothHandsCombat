...
@Mod(value = BothHandsCombat.MOD_ID, dist = Dist.CLIENT)
public final class BothHandsCombatClient {
    ...
    public BothHandsCombatClient(IEventBus modEventBus) {
        modEventBus.addListener(this::registerGuiLayers);
    }

    private void registerGuiLayers(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.HOTBAR, HOTBAR_LAYER, BothHandsCombatClient::renderHotbar);
        event.registerAbove(VanillaGuiLayers.CROSSHAIR, CROSSHAIR_LAYER, BothHandsCombatClient::renderCrosshair);
    }
